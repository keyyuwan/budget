  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1 w-[100px] shrink-0 rounded-full bg-zinc-300 group-data-[vaul-drawer-direction=bottom]/drawer-content:block dark:bg-muted" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
